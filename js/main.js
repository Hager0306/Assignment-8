...
warning: `
    ...
    <h4 class="warning-title">Extended Preparation Time</h4>

    <p class="warning-text">
      Check ingredients for allergens before preparing.
    </p>
`,
  ...
  `,
      ...
      cookTime: "60 min",
      servings: "4 people",
      ingredients: ["4 large onions, 4 tablespoons butter", "1 liter beef broth", "1/2 cup white wine", "2 bay leaves", "Fresh thyme", "Baguette slices", "200g Gruyère cheese, grated"],
      instructions: [
    ...
    },
    {
      ...
      cookTime: "15 min",
      servings: "2 people",
      ingredients: ["2 salmon fillets (6oz each)", "3 tablespoons honey", "2 tablespoons soy sauce", "2 tablespoons soy sauce", "1 tablespoon olive oil", "1 teaspoon fresh ginger, grated", "Sesame seeds for garnish","Green onions, sliced"],
      instructions: [
  ...
  `,
      ...
      cookTime: "90 min",
      servings: "4 people",
      ingredients: ["12 lasagna sheets", "500g ground beef", "400g canned tomatoes", "1 onion, diced", "2 carrots, diced", "500ml béchamel sauce", "O200g mozzarella, grated", "100g parmesan cheese", "Fresh basil"],
      instructions: [
  ...
  `,
    ...
    },
    {
      ...
      cookTime: "25 min",
      servings: "4 people",
      ingredients: ["2 tablespoons green curry paste", "400ml coconut milk", "300g chicken breast, sliced", "1 red bell pepper, sliced", "100g green beans", "1 eggplant, cubed", "2 tablespoons fish sauce", "1 tablespoon palm sugar"],
      instructions: [
...
if (recipe.warning) {
  recipeWarning.innerHTML = recipe.warning;
  recipeWarning.classList.remove("d-none");
} else {
  recipeWarning.classList.add("d-none");
}
    ...
    recipe.ingredients.forEach((ingredient,index)=>{
      ...
      ingredientsList.innerHTML += `
        ...
        <div class="d-flex align-items-start mb-4">
          ...
          <div class="ingredient-number me-3">
            ${index + 1}
          </div>
    ...
    recipe.instructions.forEach((instruction, index) => {
      ...
      instructionsList.innerHTML += `
        ...
        <div class="d-flex align-items-start mb-4">
          ...
          <div class="instruction-number me-3">
            ${index + 1}
          </div>
    ...
    // Render Nutrition
    const nutritionList =
      document.getElementById("nutrition-list");
          ...
          <div class="nutrition-card">
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center gap-3">
                ...
                <p class="nutrition-label mb-0">Calories</p>
              </div>
          ...
          <div class="nutrition-card">
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center gap-3">
                ...
                <p class="nutrition-label mb-0">Protein</p>
              </div>
          ...
          <div class="nutrition-card">
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center gap-3">
                ...
                <p class="nutrition-label mb-0">Carbohydrates</p>
              </div>
          ...
          <div class="nutrition-card">
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center gap-3">
                ...
                <p class="nutrition-label mb-0">Fat</p>
              </div>
          ...
          <div class="nutrition-card">
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center gap-3">
                ...
                <p class="nutrition-label mb-0">Fiber</p>
              </div>
          ...
          <div class="nutrition-card">
            <div class="d-flex justify-content-between align-items-center">
              <div class="d-flex align-items-center gap-3">
                ...
                <p class="nutrition-label mb-0">Sodium</p>
              </div>
    ...
    // Hide all tab contents and reset active tab
    document.querySelectorAll(".tab-content").forEach(el => el.classList.add("d-none"));
    document.querySelectorAll(".tab-btn").forEach(btn => btn.classList.remove("active"));

    // Show ingredients tab by default
    document.getElementById("ingredients-list").classList.remove("d-none");
  ...
  tabButtons.forEach((button, index) => {
    ...
    button.addEventListener("click", () => {
      ...
      tabContents.forEach(el => el.classList.add("d-none"));
